...
$output = '';
$arr_registries = is_array($arr_registries)?$arr_registries:array();
...
$arr_channels = is_array($arr_channels)?$arr_channels:array();
...
$arr_peers = is_array($arr_peers)?$arr_peers:array();
...
if(isset($modesip)){
	...
	$arr_sip = is_array($arr_sip)?$arr_sip:array();
...
if(isset($modepjsip)){
	...
	$arr_pjsip = is_array($arr_pjsip)?$arr_pjsip:array();
...
$arr_iax = is_array($arr_iax)?$arr_iax:array();
...
$arr_conferences = is_array($arr_conferences)?$arr_conferences:array();
...
$arr_subscriptions = is_array($arr_subscriptions)?$arr_subscriptions:array();
...
$arr_voicemail = is_array($arr_voicemail)?$arr_voicemail:array();
...
$arr_queues = is_array($arr_queues)?$arr_queues:array();
foreach ($arr_voicemail as $key => $value) {
	$output .= $astinfo->getOutput($value);
